  ...
  _createClass(Board, [{
    ...
    value: function createGrid() {
      ...
      $(".beats").children().each(function (idx, beat) {
        if (idx < 1) {
          var $ul = $("<ul class=\"row_" + idx + " beat-row\"><li class=\"beat-row-label\"><select id=\"track-selector-" + idx + "\" class=\"beat-track-selector\"><option value=\"" + beat.id + "\">" + beat.id + "</option><option value=\"alt-1\">alt-1</option></select></li>");
        } else {
          var $ul = $("<ul class=\"row_" + idx + " beat-row\"><li class=\"beat-row-label\"><select id=\"track-selector-" + idx + "\" class=\"beat-track-selector\"><option value=\"" + beat.id + "\">" + beat.id + "</option></select></li>");
/*          var $ul = $("<ul class=\"" + beat.id + " beat-row\"><li class=\"beat-row-label\">" + beat.id + "</li>"); */
        }
